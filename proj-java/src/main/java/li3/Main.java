...
public class Main {
    ...
    public static void main(String[] args){
        ...
        */
        ...
        long before, after;
        TADCommunity qe = new MYTCDExample();
        ...
        */
        before = System.currentTimeMillis();
        Pair<String,String> q1 = qe.infoFromPost(44347);
        after = System.currentTimeMillis();
        ...
        */
        before = System.currentTimeMillis();
        Pair<Long,Long> q3 = qe.totalPosts(LocalDate.of(2000, Month.JULY,1),
        ...
        */
        before = System.currentTimeMillis();
        List<Long> q7 = qe.mostAnsweredQuestions(11, LocalDate.of(2014,Month.AUGUST,1),
        ...
        */
        before = System.currentTimeMillis();
        List<Long> q8 = qe.containsWord(11, "kde");
        after = System.currentTimeMillis();
